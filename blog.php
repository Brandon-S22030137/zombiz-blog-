			...
			<div class="container">
				<div class="news-details">
					<div class="section-header text-center">
						<h2>Objetivo:</h2>
						<p>
						Conoce el uso de técnicas de animación en 2D y 3D en los
contextos de animación gráfica y realidad virtual considerando
los aspectos matemáticos básicos y las técnicas de
programación 
						</p>
					</div><!--/.section-header-->
