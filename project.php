				...
				<div class="container">
					<div class="service-details">
						<div class="section-header text-center">
							<h2>Objetivo.</h2>
							<p>
							Planear, diseñar e implementar la organización del espacio en
disco. Definir las fases de las instancias de un SGBD y Crear
espacios de almacenamientos dinámicos.
							</p>
							<br><br><br>
							</div><!--/.section-header-->
